...
type EmployeesByTypeRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	EmployeeType EmployeeType `protobuf:"varint,1,opt,name=employeeType,proto3,enum=proto.employee.EmployeeType" json:"employeeType,omitempty"`
}

func (x *EmployeesByTypeRequest) Reset() {
	*x = EmployeesByTypeRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *EmployeesByTypeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EmployeesByTypeRequest) ProtoMessage() {}

func (x *EmployeesByTypeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_employee_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EmployeesByTypeRequest.ProtoReflect.Descriptor instead.
func (*EmployeesByTypeRequest) Descriptor() ([]byte, []int) {
	return file_employee_proto_rawDescGZIP(), []int{5}
}

func (x *EmployeesByTypeRequest) GetEmployeeType() EmployeeType {
	if x != nil {
...
type EmployeesByTypeResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *EmployeesByTypeResponse) Reset() {
	*x = EmployeesByTypeResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *EmployeesByTypeResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EmployeesByTypeResponse) ProtoMessage() {}

func (x *EmployeesByTypeResponse) ProtoReflect() protoreflect.Message {
	mi := &file_employee_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EmployeesByTypeResponse.ProtoReflect.Descriptor instead.
func (*EmployeesByTypeResponse) Descriptor() ([]byte, []int) {
	return file_employee_proto_rawDescGZIP(), []int{6}
}

func (x *EmployeesByTypeResponse) GetEmployees() []*Employee {
	if x != nil {
		return x.Employees
	}
	return nil
...
var file_employee_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x22, 0x5a, 0x0a, 0x16, 0x45, 0x6d, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x65, 0x73, 0x42,
	0x79, 0x54, 0x79, 0x70, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x40, 0x0a, 0x0c,
	0x65, 0x6d, 0x70, 0x6c, 0x6f, 0x79, 0x65, 0x65, 0x54, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01,
	...
	,
	...
	,
...
var file_employee_proto_goTypes = []interface{}{
	...
	(*EmployeesByTypeRequest)(nil),  // 6: proto.employee.EmployeesByTypeRequest
	(*EmployeesByTypeResponse)(nil), // 7: proto.employee.EmployeesByTypeResponse
}
var file_employee_proto_depIdxs = []int32{
	...
	0, // 3: proto.employee.EmployeesByTypeRequest.employeeType:type_name -> proto.employee.EmployeeType
	1, // 4: proto.employee.EmployeesByTypeResponse.employees:type_name -> proto.employee.Employee
	2, // 5: proto.employee.EmployeeService.Employee:input_type -> proto.employee.EmployeeRequest
	4, // 6: proto.employee.EmployeeService.Employees:input_type -> proto.employee.EmployeesRequest
	6, // 7: proto.employee.EmployeeService.EmployeesByType:input_type -> proto.employee.EmployeesByTypeRequest
	3, // 8: proto.employee.EmployeeService.Employee:output_type -> proto.employee.EmployeeResponse
	5, // 9: proto.employee.EmployeeService.Employees:output_type -> proto.employee.EmployeesResponse
	7, // 10: proto.employee.EmployeeService.EmployeesByType:output_type -> proto.employee.EmployeesByTypeResponse
...
func file_employee_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_employee_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EmployeesByTypeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_employee_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EmployeesByTypeResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
